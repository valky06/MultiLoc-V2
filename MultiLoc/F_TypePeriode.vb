Public Class F_TypePeriode
    ...
    Private Sub Form_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If F_TypeListe.laSelId > 0 Then Call FormRempli(Me, "select " & lechampId & "," & lechampNom & " from " & latable & " where " & Me.lechampId & " =" & F_TypeListe.laSelId, conSql)
